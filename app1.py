...
server=app.server
app.layout = html.Div([html.H1 ('Tips Dataset Analysis'),dcc.RadioItems(
    id = 'x-axis',
    option = [
        {'label':'Sex','value':'sex'},
        {'label':'Smoker','value':'smoker'},
        {'label':'Day','value':'day'},
        {'label':'Time','value':'time'}]),dcc.Graph(id='graph')])
@app.callback(Output('graph','figure'),[Input('axis','value')])
